...
export default function ReassignWorkerModalWO({
  isOpen,
  onClose,
  workOrderId,
  currentWorkerId,
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="mb-4">
            <p className="text-sm text-gray-600 mb-2">Заказ-наряд:</p>
            <div className="bg-gray-50 p-3 rounded-lg">
              <p className="font-medium text-gray-900">{workOrderInfo.customerName}</p>
              <p className="text-sm text-gray-600">{workOrderInfo.vehicleName}</p>
            </div>
          </div>
