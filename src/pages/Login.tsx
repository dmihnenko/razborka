  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(160deg, #0A0F1E 0%, #0D1525 55%, #0A1229 100%)',
      ...
      >
        ...
        <div className="relative p-10 xl:p-12">
          <Logo size="md" withText className="[&_span]:text-white [&_.text-gray-900]:!text-white [&_.text-gray-400]:!text-slate-500" />
        </div>

        {/* Center: Hero */}
        <div className="relative px-10 xl:px-12 flex-1 flex flex-col justify-center">
          <p
          ...
          >
            Авто<wbr />бизнес<br />
            <span className="text-gradient-brand">под контролем</span>
          </h1>
          <p
            className="text-sm xl:text-base mb-10"
            style={{ color: '#64748B', maxWidth: '320px', lineHeight: '1.75' }}
          >
            ...
            {brandFeatures.map(({ icon, title, desc }) => (
              <li key={title} className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <div className="text-xs mt-0.5 leading-relaxed" style={{ color: '#475569' }}>
                    {desc}
                  </div>
                </div>
              </li>
