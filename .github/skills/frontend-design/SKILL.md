...
argument-hint: 'Component or page description + aesthetic direction, e.g. "landing page for auto parts store, industrial/dark theme"'
---
...
## TSP-V2 Specific Notes

- Project uses **Tailwind CSS** — leverage utility classes, but extend with custom CSS when needed for distinctive effects
- Use **lucide-react** for icons (already installed)
- Components go in `src/components/` — follow existing naming conventions
- Pages go in `src/pages/` — check routing in `src/App.tsx` before creating
- Dark mode: project uses `dark:` Tailwind variants
- Existing color palette: check `tailwind.config.js` for custom colors

Remember: extraordinary creative work is possible. Don't hold back — show what can truly be created when committing fully to a distinctive vision.
