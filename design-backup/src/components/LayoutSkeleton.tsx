  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="hidden md:flex md:flex-col md:w-16 lg:w-64 bg-[#0F1729] flex-shrink-0">
        <div className="h-14 border-b border-[#1E2A3B] flex items-center justify-center lg:justify-start px-2 lg:px-5 gap-3">
          <div className="w-7 h-7 rounded-lg bg-[#1E2A3B] animate-pulse flex-shrink-0" />
          <div className="hidden lg:block h-4 w-20 bg-[#1E2A3B] rounded animate-pulse" />
        </div>
        <div className="flex-1 py-3 px-2 space-y-1">
          {[...Array(7)].map((_, i) => (
            <div key={i} className="flex items-center justify-center lg:justify-start gap-3 px-1 lg:px-3 py-2 rounded-lg">
              <div className="w-5 h-5 rounded bg-[#1E2A3B] animate-pulse flex-shrink-0" />
              <div className="hidden lg:block h-4 w-28 bg-[#1E2A3B] rounded animate-pulse" />
            </div>
          ))}
        </div>
        <div className="px-2 py-3 border-t border-[#1E2A3B] space-y-1">
          <div className="flex items-center justify-center lg:justify-start gap-3 px-1 lg:px-3 py-2">
            <div className="w-5 h-5 rounded bg-[#1E2A3B] animate-pulse flex-shrink-0" />
            <div className="hidden lg:block h-4 w-16 bg-[#1E2A3B] rounded animate-pulse" />
          </div>
        </div>
      </div>
